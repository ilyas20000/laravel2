    ...
    <div class="row">
        ...
        <div class="col">
            ...
            @foreach($professeurs as $professeur)
                <div class="w-100"><img class="rounded-circle mt-5" width="150px" src="/storage/{{$professeur->image}}"/><span class="font-weight-bold  ">{{$professeur->nom}}  {{$professeur->prenom}}</span><span class="text-black-50"></span><span> </span></div>
